...
Write-Host "[e2e] regime new-signal v1"
& $Python -m py_compile (Join-Path $Root "build_regime_newsignal_v1_candidate.py")
...
$Manifest = Join-Path $Root "runs\v6_pressure_speed\manifest_regime_newsignal_v1.json"
